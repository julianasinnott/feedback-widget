...
export function FeedbackSucessStep ({ onClickButton, onFeedbackRestarRequest }: Props) {
    return (
        <>
        <header>
        ...
        <div className="flex flex-col items-center py-10 w-[304px]">
            ...
            className="py-2 px-6 mt-6 bg-zinc-700 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-[#8257e6]"
            >
                Quero enviar outro
            </button>
